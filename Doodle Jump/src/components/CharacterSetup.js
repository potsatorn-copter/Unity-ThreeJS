...
export function setupCharacter(character, sounds, scene, callback, characterName) {
...
function loadCharacterA(scene, sounds, callback) {
    loadFBXCharacter('/3D_and_Picture/A (Russian Alphabet Lore).fbx', scene, sounds, character => {
...
function loadCharacterD(scene, sounds, callback) {
    loadFBXCharacter('/3D_and_Picture/D.fbx', scene, sounds, character => {
...
export function loadCharacter(scene, sounds, callback, selectedCharacter) {
